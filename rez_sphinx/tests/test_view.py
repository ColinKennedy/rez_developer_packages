...
class SphinxConf(unittest.TestCase):
    def test_overrides(self):
        """Test :ref:`sphinx_conf_overrides` and :ref:`rez_sphinx view conf.py` at once."""
        ...
        with wrapping.keep_cwd(), run_test.keep_config() as config:
            ...
            config.optionvars["rez_sphinx"]["sphinx_conf_overrides"] = {"rst_prolog": "thing"}
    ...
    def test_overrides_not_found(self):
        """Make sure :ref:`sphinx_conf_overrides` and :ref:`rez_sphinx view conf.py` at once."""
        package = finder.get_nearest_rez_package(_CURRENT_DIRECTORY)
