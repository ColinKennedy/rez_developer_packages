...
with scope('config') as config:
    ...
    config.current_path = '/home/selecaoone/env/config/rez_developer_packages/rez_sphinx/tests/data/intersphinx_allow_weak/source_packages/weak_package'
    config.root = '/home/selecaoone/env/config/rez_developer_packages/rez_sphinx/tests/data/intersphinx_allow_weak'

timestamp = 1647396389
